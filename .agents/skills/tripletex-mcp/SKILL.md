...
Two options exist. See [feedback memory](../../../../../.Codex/projects/-Users-magnus-rodseth-dev-capra-tripletex-to-tempo/memory/feedback_sync_workflow.md) for defaults. Always `--dry-run` first, then post. Only the chargeable **Konsulentbistand** hours (7.5/day) sync — the 0.5h lunch line stays in Tripletex. Target issue: `HEIHU-1`.
...
See [user_consultant memory](../../../../../.Codex/projects/-Users-magnus-rodseth-dev-capra-tripletex-to-tempo/memory/user_consultant.md) and [feedback_sync_workflow memory](../../../../../.Codex/projects/-Users-magnus-rodseth-dev-capra-tripletex-to-tempo/memory/feedback_sync_workflow.md).
